...
public class Cid_Clearance extends TestBase {
	
	
	Login test = new Login();
	
	@Test
	public void Cid_ClearanceTest () throws InterruptedException {
		test.validLogin();
		
		String CID = "TINT PERMIT";
        driver.findElement(By.xpath(OR.getProperty("SERVICE_DROP_XPATH"))).sendKeys(CID);
